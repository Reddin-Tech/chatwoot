...
ActiveRecord::Schema[7.0].define(version: 2025_01_25_051258) do
  ...
  create_table "channel_evolutions", force: :cascade do |t|
    t.integer "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_channel_evolutions_on_account_id"
    t.index ["instance_name"], name: "index_channel_evolutions_on_instance_name", unique: true
  end
